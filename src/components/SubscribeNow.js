    ...
    <div className="relative">
      ...
      <div className="container mx-auto relative max-w-5xl bg-white rounded-lg px-12 py-10 flex items-center justify-between">
        <div>
          ...
          <div className="font-normal text-sm text-gray-500">Let's subscribe with us and find the fun.</div>
        </div>
        <button className="bg-red-500 rounded-md drop-shadow-3xl text-white p-3 px-12" type="submit">
          Subscribe Now
        </button>
      </div>
    </div>
