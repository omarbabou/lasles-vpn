...
import IconArrowLeft from '../graphics/arrow-left.png';
import IconArrowRight from '../graphics/arrow-right.png';
    ...
    <div>
      ...
      <div className="container mx-auto max-w-5xl flex flex-row justify-between items-center mt-12">
        ...
        <div className="flex flex-row space-x-5">
          ...
          <div
            className="flex self-center border bg-red-500 rounded-full p-5 cursor-pointer"
            onClick={() => fnNext()}
          >
